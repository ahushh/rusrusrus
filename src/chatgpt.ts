...
export async function getTale(token: string) {
  const content = `
  сгенерируй случайную волшебную сказку про славного парня свято-ария РУСИЧА (РУСА) белокурого Виктора Корнеплода с использованием одной, только одной, из приведенных ниже тем:
