...
Ты должен определить, какому из данных терминов больше соответствует данное предложение.  
РУС ассоциируется с тем чтобы вести и писать вежливо, грамотно, поддерживать традиционные ценности, герой,
...
помощь, любовь к природе, вегетарианство, защита.
Ящер ассоциируется с ненавистью к людям, подлость и злость, банковская система, деньги, модернизм, технологии, компьютеры, прогресс,
...
разврат, убийство, города, индустриализация, поедание мяса, политика, государство, употребление в речи мата, грубость,
...
Ответ должен состоять только из одного слова: РУС или ящер, без объяснений.`;
